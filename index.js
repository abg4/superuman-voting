...
function voteParams() {
  priceOptions.map((price) => {
    ...
    let commitVote =
      ...
      ' "to":"' + votingContract + '",' +
      ' "value": "0",' +
      ' "method":"commitVote(bytes32,uint256,bytes,bytes32)",' +
      ' "params": ["' + identifier + '","' + time + '","' + ancillaryData + '","' + hash + '"],' +
      ' "operation":"0"' +
      "},";
    ...
    let revealVote =
      ...
      ' "to":"' + votingContract + '",' +
      ' "value": "0",' +
      ' "method":"revealVote(bytes32,uint256,int256,int256)",' +
      ' "params": ["' + identifier + '","' + time + '","'+ price + '","' + salt + '"],' +
      ' "operation":"0"' +
      "}]";
    ...
    ' "To (address)":"' + votingContract + '",\n' +
    ' "value": "0",\n' +
    ' "function": "retrieveRewards()",\n' +
    ' "voterAddress (address)":"' + account + '",\n' +
    ' "roundId (uint256)":"' + roundId + '",\n' +
    ' "toRetrieve (tuple[])": [{"identifier":"' + identifier + '","time":"' + time + '","ancillaryData":"' + ancillaryData + '"}]\n';
